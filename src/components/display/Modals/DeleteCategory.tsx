...
export default class DeleteCategory extends React.Component <IDeleteCatProps, IDeleteCatState>{
    ...
    constructor(props:IDeleteCatProps) {
        super(props)
        this.state ={
            modalIsOpen: false,
        }
                ...
                <div className="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-custom-darkblue-dark shadow-xl rounded-2xl">
                    ...
                    <div className="mt-2">
                        ...
                        {this.props.categoryInfo.collections.length > 0
                            ? <>
                                <p className="text-white">Deleting <b>'{this.props.categoryInfo.name}'</b> will also delete:</p>
                                <p className="text-custom-orange text-sm font-semibold">{this.props.categoryInfo.collections.length} Collections and their associated affirmations.</p>
                              </>
                            : <>
                                <p className="text-white">Deleting {this.props.categoryInfo.name} will not effect your collections/affirmations.</p>
                            </>
